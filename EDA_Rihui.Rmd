...
X=na.omit(X)
```
Correlation heat map. There are relatuvely high dependency between pcb variables, which may cause the multicolinearity issue. The association between treatment variables and tri or cho is weak.
```{r}
