...
```{r}
posterior_interval(m) %>% round(2) %>% kable("latex")
```
```{r} 
posterior_interval(m_r2_03) %>% round(2) %>% kable("latex")
```
for .5
```{r}
posterior_interval(m_r2_05) %>% round(2) %>% kable("latex")
```
for .8
```{r}
posterior_interval(m_r2_08) %>% round(2) %>% kable("latex")
```
