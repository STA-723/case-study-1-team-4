...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(predvars, data, env): oggetto "{}race\_agg"{} non trovato}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in FUN(X[[i]], ...): oggetto "{}log\_likelihood"{} non trovato}}\end{kframe}
