...
\sectionref{sec:data} introduces the data and \sectionref{sec:method} presents our methodology.
\sectionref{sec:results} describes our finding.
We discuss these and conclude the report in \sectionref{sec:conclusion} concludes.
