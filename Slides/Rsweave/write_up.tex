...
We fit our Bayesian model via {\t Stan} using $10$ chains of $10,000$ iterations each.
...
We gave the 90\% credible intervals for coefficients and their posterior mean. (Table \ref{tab:confints_unif}). The interpretation of coefficients are as follow:
\begin{itemize}
