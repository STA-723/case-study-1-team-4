...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Appendix}{Frequentist Model Checking}
<<results='hide', echo=FALSE, cache=TRUE, warning=FALSE>>=
d_subset= d %>% 
...
#surr_pcb = autoplot(res, what = "covariate", x =d$pcb_env_bc, xlab = "Adjusted PCB")
#surr_dde = autoplot(res, what = "covariate", x =d$dde_env_bc, xlab = "Adjusted DDE")
#surrresid =  ggarrange(surr_dde,surr_pcb, ncol = 2)
@
...
\begin{frame}{Appendix}{Frequentist Model Checking}
<<echo=FALSE>>=
#autoplot(res, what = "qq", x =d$pcb_env_bc, xlab = "Adjusted PCB")
@
\begin{figure}
  \centering
