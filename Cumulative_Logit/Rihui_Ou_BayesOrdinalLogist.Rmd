...
I try to subsample the original dataset (I delete 1200 datapoints with label 2 to make the dataset more balanced), this is to say, subsample the majority group in this case to make our dataset more balanced.
```{r}
