...
\begin{figure}[htbp]
	...
	{\includegraphics[width=0.6\linewidth]{outcome_per_center}}
\end{figure}
...
\begin{figure}[htbp]
	...
	{\includegraphics[width=0.6\linewidth]{pcb_dde_per_gest}}
\end{figure}
